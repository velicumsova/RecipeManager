...
public class DatabaseHandler {
    ...
    public static List<RecipeSummary> getAllRecipeSummaries() {
        ...
        String selectRecipes = "SELECT id, title, imagepath, cuisine, category, difficulty, cookingtime  FROM recipes";
        try (Connection connection = getDbConnection();
            ...
            while (resultSet.next()) {
                ...
                recipeList.add(new RecipeSummary(id, title, imagepath, cuisine, category, difficulty, cookingTime));
            }
